...
const { createPoll, getAllPolls, getVotedPolls, getPollById, voteOnPoll, closePoll, bookmarkPoll, getBookmarkedPolls, deletePoll } = require("../controllers/pollController");
